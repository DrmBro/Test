var sArray = new Object;
	sArray[0] = new Image;
	sArray[0].src = "http://www.bcjy123.com/jj/inc1/icon_star_1.gif";
	for (var i=1; i<6; i++) {
		sArray[i] = new Image();
		sArray[i].src = "http://www.bcjy123.com/jj/inc1/icon_star_2.gif";
	}
	var starTimer;
	var pro ; 
	var rate ; 
	function initStar() {
		...
		try {
			...
			setProfix("shijing_");
			setStars(document.getElementById("shijing").value,'shijing');
		} catch(e){
